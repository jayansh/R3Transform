  ...
  public static void main(String args[]) throws ParseException {
    ...
    while((st = p.readStatement()) != null) {
    	if(st instanceof ZQuery){
    		ZQuery zQuery = (ZQuery) st;
    		System.out.println(zQuery.getFrom());
    		System.out.println(zQuery.getSelect());
    		System.out.println(zQuery.getWhere());
    		
    	}else if(st instanceof ZInsert){
    		ZInsert zInsert = (ZInsert) st;
    		System.out.println(zInsert.getTable());
    		System.out.println(zInsert.getColumns());
    		System.out.println(zInsert.getQuery());
    	}

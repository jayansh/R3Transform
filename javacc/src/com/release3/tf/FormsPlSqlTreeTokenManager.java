/* Generated By:JJTree&JavaCC: Do not edit this line. FormsPlSqlTreeTokenManager.java */
package com.release3.tf;

/** Token Manager. */
public class FormsPlSqlTreeTokenManager implements FormsPlSqlTreeConstants
{
...
/** Constructor. */
public FormsPlSqlTreeTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public FormsPlSqlTreeTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}

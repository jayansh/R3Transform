...
class FormsPlSql implements FormsPlSqlConstants {
  public static void main(String args []) throws ParseException
  {
    ...
    else
    {
      try
      {
        p = new FormsPlSql(new DataInputStream(new FileInputStream(args [0])));
      }
...
/* Represents a PLSQL code block. */
  ...
  CompilationUnit comilationUnit = null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case K_PROCEDURE:
  ...
  Declaration decl = new IdentifierDeclaration();
  ...
  Declaration decl = new CursorDeclaration();
  ...
  Declaration decl = new PragmaDeclaration();

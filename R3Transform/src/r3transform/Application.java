...
public class Application implements IApplication {
	...
	public Object start(IApplicationContext context) {
		...
		try{
			...
			// location
			boolean remember = WorkspaceChooserDialog.isRememberWorkspace();

			// get the last used workspace location
			String lastUsedWs = WorkspaceChooserDialog
			...
			if (remember) {
				...
				String ret = WorkspaceChooserDialog.checkWorkspaceDirectory(
			...
			if (!remember) {
				WorkspaceChooserDialog pwd = new WorkspaceChooserDialog(false,

...
public class ZqlJJParser implements ZqlJJParserConstants {
	...
	public static void main(String args[]) throws ParseException {
		...
		if (args.length < 1) {
			...
			try {
				p = new ZqlJJParser(new DataInputStream(new FileInputStream(
						args[0])));
	...
	static final public ZTransactStmt SetTransactionStatement()
	...
	static final public ZExpression SQLRelationalOperatorExpression()
			throws ParseException {
		ZExpression e;
		ZExp e1, eright;
		String op;
	...
	static final public ZExp SQLSimpleExpressionOrPreparedCol()
			throws ParseException {
		ZExp e;
		switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
		case K_AVG:
	...
	static final public ZExpression IsNullClause() throws ParseException {
		...
		{
			if (true)
				return (not ? new ZExpression("IS NOT NULL") : new ZExpression(
						"IS NULL"));
		}
		throw new Error("Missing return statement in function");
	}
	...
	// OP ::= * | /
	static final public ZExp SQLMultiplicativeExpression()
			throws ParseException {
		Token op;
		ZExp e1, e2;
		ZExpression e = null;
	...
	static final public ZExp SQLPrimaryExpression() throws ParseException {
		...
		default:
			...
			if (jj_2_12(2147483647)) {
				...
				{
					if (true)
						return new ZExpression("COUNT", new ZConstant("*",
				...
				{
					if (true)
						return new ZExpression(s, new ZConstant(modifier + s2,
								ZConstant.COLUMNNAME));
				}
			} else if (jj_2_15(2)) {
				e = FunctionCall();
